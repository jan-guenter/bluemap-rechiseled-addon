...
This deterministic datapack contains exactly 1,924 logical cases and 2,203
verified placements:
...
stair family covers all 80 legal states; all 12 axis IDs cover x/y/z. The full
isolated census contains all 27 routed glowstone IDs.
