...
public final class DefinitionCatalog {
    ...
    private final Map<String, RechiseledDefinition> definitions;

    private DefinitionCatalog(Map<String, RechiseledDefinition> definitions) {
    ...
    public static DefinitionCatalog load(String resource, int expectedRows, String expectedSha256) {
        ...
        Map<String, RechiseledDefinition> definitions = new LinkedHashMap<>();
        ...
        for (String line : text.split("\n", -1)) {
            ...
            RechiseledDefinition definition = new RechiseledDefinition(
    ...
    public Map<String, RechiseledDefinition> definitions() {
        return definitions;
    }
