...
public final class ProfileDisablement {
    ...
    public static final String SYSTEM_PROPERTY = "bluemap.rechiseled.disabledProfiles";
    public static final String ENVIRONMENT_VARIABLE = "BLUEMAP_RECHISELED_DISABLED_PROFILES";
